...
def serial_master(file_path, sn_M):
    ...
    with open(file_path, 'r') as file: #open the file
        ...
        if serial_master == '0':
            print('There is no master for this test')
...
def serial_client_1(file_path, sn_C_1):
    ...
    with open(file_path, 'r') as file: #open the file
        ...
        if serial_client_1 == '0':
            print('There is no client for this test.')
...
def Test_Duration_Master(Debut, Fin):
    if Test_Start_Master_s == None or Test_End_Master_s == None:
...
def Test_Duration_Client(Debut, Fin):
    if Test_Start_Client_s == None or Test_End_Client_s == None:
        print('No Desintegration')
    else:
